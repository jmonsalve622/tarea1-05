public class Main1 {
  public static void main(String[] args) {
    ...
    Select s = Selleccion.COCASELECCION;
    ...
    s = new Selleccion.FANTASELECCION;
    m = new Moneda1000();
    ps.add(m);                               //Comprar Fanta con 1000 pesos
    c = new Comprador(m,s,exp);
    System.out.println(c.queCompraste()+", "+c.cuantoVuelto());

    s = new Selleccion.SPRITESELECCION;
    m = new Moneda1000();
    ps.add(m);                               //Comprar Sprite con 1000 pesos
    c = new Comprador(m,s,exp);
    System.out.println(c.queCompraste()+", "+c.cuantoVuelto());

    s = new Selleccion.SNICKERSSELECCION;
    m = new Moneda1000();
    ps.add(m);                               //Comprar Snickers con 1000 pesos
    c = new Comprador(m,s,exp);
    System.out.println(c.queCompraste()+", "+c.cuantoVuelto());

    s = new Selleccion.SUPER8SELECCION;
    m = new Moneda500();
